...
def get_parsed():
  ...
  parser.add_argument('-g', '--good', action='store_const', dest='wanted', const=[THE.GOOD], help='output includes only [GOOD] results')
  parser.add_argument('-b', '--bad', action='store_const', dest='wanted', const=[THE.FAIL], help='output includes only [FAIL] results')
  parser.add_argument('-i', '--ignore', action='store', dest='ignore', help='location of ignore file')
